    ...
    public class MarkarthMilk : Drink, IOrderItem, INotifyPropertyChanged
    {
        ...
        public override double Price
        {
            get
            {
                switch (Size)
                {
                    case Size.Small: return DrinkPricesAndCalories.SMALL_MARKARTH_MILK_PRICE;
                    case Size.Medium: return DrinkPricesAndCalories.MEDIUM_MARKARTH_MILK_PRICE;
                    case Size.Large: return DrinkPricesAndCalories.LARGE_MARKARTH_MILK_PRICE;
        ...
        public override uint Calories
        {
            get
            {
                switch (Size)
                {
                    case Size.Small: return DrinkPricesAndCalories.SMALL_MARKARTH_MILK_CALORIES;
                    case Size.Medium: return DrinkPricesAndCalories.MEDIUM_MARKARTH_MILK_CALORIES;
                    case Size.Large: return DrinkPricesAndCalories.LARGE_MARKARTH_MILK_CALORIES;
                    default: throw new NotImplementedException("Should never be reached");
                }
            }
        }
